...
then
	...
	f_action_install "$CA_PACKUTILE" "net-tools build-essential gettext curl vim neofetch ncdu ffmpegthumbs ffmpegthumbnailer xterm inxi hdparm cpu-x rsync ppa-purge speedtest-cli dos2unix iftop lshw"
	...
	f_action_install "$karim" "cinnamon-desktop-environment open-vm-tools open-vm-tools-desktop" 
	#dbarrier stacer open-vm-tools open-vm-tools-desktop
