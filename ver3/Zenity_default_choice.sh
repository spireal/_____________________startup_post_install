...
GUI=$(zenity --list --checklist --height 850 --width 1400 \
	...
	$(chkDef "FALSE") "$CA_FIREFOXDEB" "$CD_FIREFOXDEB" \
	...
	$(chkDef "TRUE") "$CA_WHATSDESK" "$CD_WHATSDESK" \
	...
	$(chkDef "FALSE") "$CA_TRANSMISSION" "$CD_TRANSMISSION" \
	...
	$(chkDef "FALSE") "$CA_REMMINA" "$CD_REMMINA" \
    	$(chkDef "TRUE") "$CA_TEAMVIEWER" "$CD_TEAMVIEWER" \
    	$(chkDef "FALSE") "$CA_WORMHOLE" "$CD_WORMHOLE" \
    	$(chkDef "FALSE") "$CA_X2GO" "$CD_X2GO" \
    	$(chkDef "FALSE") "$CA_X11VNC" "$CD_X11VNC" \
	FALSE "$SCT_OFFICE" "===========================================================" \
	$(chkDef "TRUE") "$CA_CALIBRE" "$CD_CALIBRE" \
	...
	$(chkDef "FALSE") "$CA_LIBREOFFICEDEPOT" "$CD_LIBREOFFICEDEPOT" \
	...
	$(chkDef "TRUE") "$CA_SAMBANFS" "$CD_SAMBANFS" \
